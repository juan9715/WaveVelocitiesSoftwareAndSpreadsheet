...
for aa = 1:nmetodos
    ...
    figure(1)
    ejeActual = gca;
    h=findobj('type','line','LineStyle','--','parent',ejeActual);
    delete(h);
    h=findobj('type','line','LineStyle','--','parent',eje1);
    delete(h);
    h=findobj('type','line','LineStyle','--','parent',eje2);
    delete(h);
...
for aa = 1:nmetodos
    ...
    plot(idArchivos,tArrivals,color);
    ...
    % Graficar en la ventana principal los resultados
    % de arrival
    plot(idArchivos,tArrivals,color,'parent',eje1);
